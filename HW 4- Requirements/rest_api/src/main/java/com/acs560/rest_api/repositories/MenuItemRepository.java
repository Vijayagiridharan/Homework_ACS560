...
public class MenuItemRepository {
     ...
     *
     * This method filters the menu items based on the provided category name
     * and returns a list of menu items that match. The comparison is case-insensitive,
     * meaning that "desserts", "Desserts", and "DESSERTS" will all yield the same results.
     *
     * @param categoryName the name of the category to filter menu items by. This parameter
     *                     should not be null or empty.
     * @return a List of {@link MenuItem} objects that belong to the specified category.
     *         If no menu items are found in the specified category, an empty list is returned.
     */
