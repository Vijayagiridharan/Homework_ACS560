...
import com.acs560.rest_api.views.FormFactory;
...
public class MenuItemView extends VerticalLayout {
    ...
    private void openFormDialog(MenuItemEntity menuItem) {
        ...
        FormFactory formFactory = new FormFactory(categoryService, menuItemService);
        MenuItemForm form = formFactory.createMenuItemForm(menuItem);
